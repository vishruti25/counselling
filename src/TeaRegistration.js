...
const  TeaRegistration = () => {
    ...
    const handleSubmit = (event) =>{
        ...
        {
            axios.post('http://localhost:8090/api/collections/teacher_Registration/records', formData)
            .then(res => {
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="signup-form">
                ...
                <p class="text-center mt-3 text-secondary">If you have account, Please <Link to={"/tealogin"}>Login Now</Link></p>
            </div>
        </div>
    </div>
</div>
...
export default TeaRegistration